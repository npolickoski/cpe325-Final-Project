...
char arrowSent = 0;                                                 // flag: 0 - arrow in-progress, 1 - arrow sent
char endSong = 'p';                                                 // flag: p = song in-progress, w = end of song win, l = end of song lose
char slowAss = 0;                                                   // flag: 0 - no direction change, 1 - direction change
...
void main(void)
{
    ...
    while (play == 'y')
    {
        ...
        while (endSong == 'p')
        {
            if (songIter == *songLenPtr)                            // If end-of-song reached --> WIN
            {
            ...
            if (endSong == 'l')                                     // if player waited too long --> LOSE
            {
                break;
            }

            arrowSent = 0;                                          // reset sent arrow flag to False
            slowAss = 0;                                            // reset slow flag
...
void directConfirm(void)
{
    ...
    {
        slowAss = 1;                                        // set flag to direction change
